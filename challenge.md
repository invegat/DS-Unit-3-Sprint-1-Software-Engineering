...
- What, in your opinion, is an important part of code reviews? That is, what is
  ...
  The most important part of code reviews is checking if the code meets the target 
  set by the coder.   If the code doesn't meet the target hopefully the coder
  shows a workable code arcitecture.   The coder should use any python packages 
  reviewed in class and not violate don't-repeat-yourself.  Innovative
  coder coding should be recognized and learned from.      

- We have an awful lot of computers here, and it gets pretty confusing with
  slightly different things running on all of them. How could containers help us
  improve this situation?

  We can all use the same contianer OS - ubuntu.  By using the same docker image student
  setup time is standardized and reduced.   OS ruining reckless installing and configuring 
  is fixable by reloading the image.  
